$(document).ready(() => {
  ...
  let skillsTweenTimeline = new TimelineMax()
    .add([headerSlideIn("#skills-header", skillsEasing)], 0)
    .add(
      [
        // hexagon rotate in
        TweenMax.fromTo(
  ...
  const aboutTweenTimeline = new TimelineMax()
    .add([headerSlideIn("#about-header", aboutEasing)], 0)
    .add([headerSlideIn(".about-description", aboutEasing)], 0.5);
  ...
  const projectsTweenTimeline = new TimelineMax()
    .add([headerSlideIn("#projects-header", projectsEasing)], 0)
    .add(
      [
        TweenMax.fromTo(
          [".project-images"],
  ...
  const contactTweenTimeline = new TimelineMax()
    .add(
      TweenMax.fromTo(
        ["#contact-header"],
        1,
  ...
  toggleHeroText = (on_off) => {
    ...
    if (on_off) {
      // toggle text/tint ON
      heroTweenTimeline = new TimelineMax()
        .add(
          [
            TweenMax.fromTo(
              [guessButton],
  ...
  startGame = () => {
    let moveHandler = (e) => {
      ...
      if (
        Math.abs(x - mouseX) > mouseTravel ||
        Math.abs(y - mouseY) > mouseTravel
      ) {
        mouseX = x;
        mouseY = y;
      ...
      for (let star in star_coordinates) {
        ...
        if (
          Math.abs(x - starX) <= mouseDistance &&
          Math.abs(y - starY) <= mouseDistance
        ) {
          animateCanvas(
            sagittarius,
            starX,
          ...
          for (let line_coordinate in sagittarius_lines) {
            ...
            if (
              !(line_coordinate in star_coordinates) &&
              !(line_coordinate2 in star_coordinates)
            ) {
              let starX1 =
                  star_coordinates2[line_coordinate][0] * sagittarius.width,
                starY1 =
                  star_coordinates2[line_coordinate][1] * sagittarius.height,
                starX2 =
                  star_coordinates2[line_coordinate2][0] * sagittarius.width,
                starY2 =
                  star_coordinates2[line_coordinate2][1] * sagittarius.height;
              ctx.beginPath();
              ctx.lineWidth = 3;
  ...
  const addText = (heading, subheading, description) => {
    const modalBody = document.getElementById("projects-modal-body"),
      ...
      modalProjectSubHeading =
        '<h5 id="modalProjectSubHeading">' + subheading + "</h5>",
      modalProjectDescription =
        '<p id="modalProjectDescription">' + description + "</p>",
      closeButton =
  ...
  const appendProjectImages = (parentFolder, images) => {
    ...
    for (let image of images) {
      let slideImg =
        ...
        "</div>";
      document
        .getElementById("projectSlides")
        .insertAdjacentHTML("beforeend", slideImg);
    }
  ...
  const addWebIcon = (link) => {
    const icon =
      ...
      "</a>";
    document
      .getElementById("projects-modal-body")
      .insertAdjacentHTML("beforeend", icon);
  };
      ...
      switch (e.target.id.toString()) {
        case "Fireflies":
          (images = ["home", "ways-to-spark-change", "careers", "footer"]),
            ...
            (desc =
              "Fireflies is a one-stop platform for advocacy. Support the causes you care about, track your impact, and share your experiences with the world.");
        ...
        case "eServeLaw":
          (images = [
            ...
            (heading = "eServeLaw"),
            (subHeading = "Nationwide Process Serving"),
            (desc =
              "eServeLaw's mission is to provide quality legal services nationwide to people and corporations with a quick and affordable approach. They are determined to be the most consumer-centric company in the nation, by always striving to delight their customers and make their lives easier, one innovative service at a time.");

          appendProjectImages("eservelaw", images);
          addText(heading, subHeading, desc);
          addWebIcon("https://eservelaw.com/");
        ...
        case "QueueingSystem":
          ...
          (heading = "Queueing System"),
            ...
            (desc =
              "Managing long lines of customers with pen and paper can be a daunting task. With a queueing system, customers can schedule an appointment and receive status updates with ease.");
        ...
        case "FireDrop":
          (images = ["home", "drops", "raffle", "merchandise", "about"]),
            ...
            (desc =
              "FireDrop is a static website with front-end form validation. I created this as my final project for a web design class at Baruch.");
        ...
        case "AscendBaruch":
          (images = ["home", "about", "committees", "eboard"]),
            ...
            (desc =
              "Ascend Baruch's mission is to be the premier professional organization dedicated to enabling its members, business partners and the community to leverage the leadership and global business potential of Pan-Asians.");
        ...
        case "EZDoctDjango":
          (images = [
            ...
            (desc =
              "After learning the basics of client and server side development, I decided to use a more modern development stack improve upon the EZDoct app I've built previously.");
        ...
        case "mediaManagement":
          (images = ["login", "admin", "add_tv", "configure"]),
            ...
            (desc =
              "This app was created for Baruch's marketing team so they can easily upload, delete, and manage Baruch's promotional videos.");
        ...
        case "BaruchDonorPHP":
          (images = ["preview", "home", "view_donors", "view_pc"]),
            ...
            (desc =
              "Baruch decided to honor their supporters by adding their names to desktop backgrounds across the computer labs. This application manages donor information and automatically generates desktop backgrounds.");
        ...
        case "arduinoSmarthome":
          (images = ["entire_system", "lcd", "mockup"]),
            ...
            (desc =
              "During my last semester of high school, I had the opportunity to research any one programming language of my choice. Rather than limiting myself to only software development, I decided to build a smarthome system using the Arduino platform.");

          appendProjectImages("arduino_smarthome", images);
          addText(heading, subHeading, desc);
          addGithubIcon(
            "https://github.com/junh4533/independent_study-arduino"
          );
